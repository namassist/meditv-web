  ...
  return (
    <main className="flex h-screen flex-col overflow-hidden bg-(--meditv-background) text-(--meditv-foreground)">
      ...
      {allQueuesEmpty ? (
        ...
        <>
          <section className="flex h-[43vh] shrink-0 flex-col justify-center gap-[1vh] px-[1.5vh] py-[1vh]">
          ...
          <section className="grid h-[47vh] shrink-0 grid-cols-[4fr_2fr_2fr] gap-[1.5vh] px-[1.5vh] pb-[1.5vh] pt-[0.5vh]">
            <div className="min-h-0">
              <MeditvVideoCard
                videoUrl={screenData.videoUrl}
                isMuted={isSpeaking}
